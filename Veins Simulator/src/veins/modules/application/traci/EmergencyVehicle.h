...
#include <chrono>
#define NODES_NUMBER 168

class EmergencyVehicle : public BaseWaveApplLayer {
	public:
	...
	protected:
		...
		void joinPaths(int path[][NODES_NUMBER], int v, int u);
		std::list<std::string> getOptimalRouteThroughFloydWarshall(int origin, int end);
};
