...
#include "veins/modules/application/traci/AccidentVehicleNoV2X.h"
...
Define_Module(AccidentVehicleNoV2X);
...
void AccidentVehicleNoV2X::initialize(int stage)
{
...
void AccidentVehicleNoV2X::finish()
{
...
void AccidentVehicleNoV2X::onWSA(WaveServiceAdvertisment* wsa) {
...
void AccidentVehicleNoV2X::onBSM(BasicSafetyMessage *bsm)
{
   
}


void AccidentVehicleNoV2X::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind())
    {
        //é BSM
...
void AccidentVehicleNoV2X::createAndSendBSM(std::string xml)
{
    if(!xml.empty())
    {
        BasicSafetyMessage* bsm = new BasicSafetyMessage();
...
void AccidentVehicleNoV2X::handleLaneChanging()
{
...
bool AccidentVehicleNoV2X::checkIfSingleLane()
{
...
void AccidentVehicleNoV2X::handlePositionUpdate(cObject* obj)
{
...
void AccidentVehicleNoV2X::onWSM(WaveShortMessage* wsm)
{}
