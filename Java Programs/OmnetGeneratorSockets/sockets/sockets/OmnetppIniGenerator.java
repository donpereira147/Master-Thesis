...
public class OmnetppIniGenerator 
{
	public static void main(String[] args)
	{
		...
		String restOfTheFile = "*.rsu[*].appl.headerLength = 80 bit\r\n" + 
				...
				"#                    WaveAppLayer                        #\r\n" + 
				"##########################################################\r\n" + 
				"*.manager.moduleType = \"EmergencyVehicle=org.car2x.veins.nodes.Car JustSirenEmergencyVehicle=org.car2x.veins.nodes.Car  AccidentVehicle=org.car2x.veins.nodes.Car SlowVehicle=org.car2x.veins.nodes.Car JustKerbsVehicle=org.car2x.veins.nodes.Car SocketEmergencyVehicle=org.car2x.veins.nodes.Car SocketNormalVehicle=org.car2x.veins.nodes.Car SocketRSUSimulatorVehicle=org.car2x.veins.nodes.Car *=org.car2x.veins.nodes.Car\"\r\n" + 
				"*.manager.moduleName=\"EmergencyVehicle=emergency JustSirenEmergencyVehicle=siren AccidentVehicle=accident SlowVehicle=slow JustKerbsVehicle=kerbs SocketEmergencyVehicle=socketEV SocketNormalVehicle=socketNV SocketRSUSimulatorVehicle=socketRSU *=node\"\r\n" + 
				"\r\n" + 
				...
				"\r\n" + 
				"*.socketEV[*].applType = \"SocketEmergencyVehicle\"\r\n" + 
				"*.socketEV[*].appl.headerLength = 80 bit\r\n" + 
				"*.socketEV[*].appl.sendBeacons = false\r\n" + 
				"*.socketEV[*].appl.dataOnSch = false\r\n" + 
				"*.socketEV[*].appl.beaconInterval = 1s\r\n" + 
				"\r\n" + 
				"*.socketNV[*].applType = \"SocketNormalVehicle\"\r\n" + 
				"*.socketNV[*].appl.headerLength = 80 bit\r\n" + 
				"*.socketNV[*].appl.sendBeacons = false\r\n" + 
				"*.socketNV[*].appl.dataOnSch = false\r\n" + 
				"*.socketNV[*].appl.beaconInterval = 1s\r\n" + 
				"\r\n" + 
				"*.socketRSU[*].applType = \"SocketRSUSimulatorVehicle\"\r\n" + 
				"*.socketRSU[*].appl.headerLength = 80 bit\r\n" + 
				"*.socketRSU[*].appl.sendBeacons = false\r\n" + 
				"*.socketRSU[*].appl.dataOnSch = false\r\n" + 
				"*.socketRSU[*].appl.beaconInterval = 1s\r\n" + 
				"\r\n" + 
				...
				"\r\n" + 
				"*.socketEV[*].veinsmobilityType.debug = true\r\n" + 
				"*.socketEV[*].veinsmobility.x = 0\r\n" + 
				"*.socketEV[*].veinsmobility.y = 0\r\n" + 
				"*.socketEV[*].veinsmobility.z = 1.895\r\n" + 
				"\r\n" + 
				"*.socketNV[*].veinsmobilityType.debug = true\r\n" + 
				"*.socketNV[*].veinsmobility.x = 0\r\n" + 
				"*.socketNV[*].veinsmobility.y = 0\r\n" + 
				"*.socketNV[*].veinsmobility.z = 1.895\r\n" + 
				"\r\n" + 
				"*.socketRSU[*].veinsmobilityType.debug = true\r\n" + 
				"*.socketRSU[*].veinsmobility.x = 0\r\n" + 
				"*.socketRSU[*].veinsmobility.y = 0\r\n" + 
				"*.socketRSU[*].veinsmobility.z = 1.895\r\n" + 
				"\r\n" + 
